...
```{r, eval=TRUE, echo=FALSE, fig.height=5, fig.show='hold', fig.width=8, message=FALSE, warning=FALSE, paged.print=FALSE}
library(maps)
...
gGLlot(datadist2, aes(x=Year, y=NEP)) + geom_boxplot(outlier.colour="black", outlier.shape=16,
             outlier.size=2, notch=T,fill='steelblue') +
    	    theme(panel.background=element_rect(fill = "white", colour = "black"))+ labs( y="Nivel de Fragmentacion Politica",x="") 
```
